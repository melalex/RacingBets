...
/**
 * DTO for RaceParticipantThumbnail class
 *
 * @author Alexander Melashchenko
 * @version 1.0 23 Mar 2017
 */
public class RaceParticipantThumbnailDto implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        RaceParticipantThumbnailDto that = (RaceParticipantThumbnailDto) o;
        ...
        if (minBet != null ? !minBet.equals(that.minBet) : that.minBet != null) {
            return false;
        }
    ...
    public String toString() {
        return "RaceParticipantThumbnailDto{" +
                "id=" + id +
                ", name='" + name + '\'' +
